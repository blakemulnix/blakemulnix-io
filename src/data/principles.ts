...
export const principles: Principle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'The outcome is that the team delivers reliably for years rather than impressing stakeholders one quarter and fighting fires the next.',
