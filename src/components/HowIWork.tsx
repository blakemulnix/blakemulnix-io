    ...
    <ol className="mt-12 space-y-12">
      {principles.map((p, i) => (
        <li
          ...
          style={{ borderColor: `${palette.rust}4d` }}
        >
          ...
          <p
            className="mt-3 max-w-2xl font-serif text-lg italic sm:text-xl"
          ...
          <div
            className="mt-3 max-w-2xl space-y-3 text-[15px] leading-relaxed"
