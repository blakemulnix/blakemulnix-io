...
/*
 * Inline SVGs so icons inherit currentColor and add no network requests.
 * Each is decorative; the accessible name lives on the surrounding control.
 */
...
export const StravaIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
